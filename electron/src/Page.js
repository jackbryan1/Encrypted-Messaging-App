        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Typography align={"left"} sx={{ 'padding-left': 30 }}>
                    ...
                    functions that produce elliptic curve keys.
                    These keys are typically key pairs with a public key and a private key
                    <br/><br/>
                    ...
                    it. Bob will then be able to attempt todecrypt the ciphertext using the secret key and associated
